...
vlog -work work ../../example_design/ethernetmac.v
vlog -work work ../../example_design/ethernetmac_block.v
vlog -work work ../../example_design/ethernetmac_locallink.v
vlog -work work ../../example_design/ethernetmac_example_design.v
